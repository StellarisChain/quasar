// Direct test of address format utilities (TypeScript module test)
const path = require('path');
const { fileURLToPath } = require('url');

// Use esbuild to compile and run our test
...
import { 
    ...
    getAddressInfo,
    AddressType
} from '../src/lib/address_format_utils';
...
try {
    ...
    console.log('\\nStellaris address matches expected:', addresses.stellaris === expectedStellarisAddress);
    ...
    console.log('  Stellaris info:', JSON.stringify(stellarisInfo));
    const ethereumInfo = getAddressInfo(addresses.ethereum);
    console.log('  Ethereum info:', JSON.stringify(ethereumInfo));
